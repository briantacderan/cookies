og = Menu.create(season: 'original', info: 'Original recipes from Cookies by Relle')
...
fall = Menu.create(season: 'new_seasonal', info: 'New or seasonal cookies at exclusive and limited quantities')
